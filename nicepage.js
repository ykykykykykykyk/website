    ...
    7968: function(t, e, i) {
        ...
        n((function() { n(".u-nav-container .u-nav-link").each((function() { window._npInitMenuLink(n(this)) })), n(".u-nav-container-collapse .u-nav-link").each((function() { window._npInitMenuLink(n(this), true) })) })), window._npInitMenuLink = function t(e, i) {
            var o = n("body"),
                ...
                g = f.replace(/^[^#]+/, "");
            if (!g || "#" === g || !n(g).length)
                if (p && window.location.href.toString() === h || v && m === v || l && p === l) { var y = e; if (!c || i) y = e.parents(".u-nav-item").children(".u-nav-link"); if (y.addClass("active"), "with-reload" === u && i) y.siblings(".u-nav-popup").addClass("open").css("max-height", "none") }
        }
    },
    7969: function(t, e, i) {
        "use strict";
